	...
	struct msm_camera_sensor_flash_data *fdata, unsigned led_state)
{
    ...
    {   
        pr_err("msm_camera_flash_set_led_state: ERR: fdata->flash_type or fdata->flash_src is invalid !\n");
		return -ENODEV;
    }
    
	switch (fdata->flash_src->flash_sr_type) {
	case MSM_CAMERA_FLASH_SRC_PMIC:
        CDBG("msm_camera_flash_set_led_state: MSM_CAMERA_FLASH_SRC_PMIC \n");
		rc = msm_camera_flash_pmic(&fdata->flash_src->_fsrc.pmic_src,
			led_state);
		break;

	case MSM_CAMERA_FLASH_SRC_PWM:
        CDBG("msm_camera_flash_set_led_state: MSM_CAMERA_FLASH_SRC_PWM \n");
		rc = msm_camera_flash_pwm(&fdata->flash_src->_fsrc.pwm_src,
			led_state);
		break;

	case MSM_CAMERA_FLASH_SRC_CURRENT_DRIVER:
        CDBG("msm_camera_flash_set_led_state: MSM_CAMERA_FLASH_SRC_CURRENT_DRIVER \n");
	...
	case MSM_CAMERA_FLASH_SRC_EXT:
        CDBG("msm_camera_flash_set_led_state: MSM_CAMERA_FLASH_SRC_EXT \n");
	...
	case MSM_CAMERA_FLASH_SRC_LED1:
        CDBG("msm_camera_flash_set_led_state: MSM_CAMERA_FLASH_SRC_LED1 \n");
    ...
    CDBG("msm_camera_flash_set_led_state: End, rc = %d \n", rc);
	return rc;
}
